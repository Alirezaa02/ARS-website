      ...
      <div className="mx-auto max-w-3xl px-6">
        <Reveal>
          ...
          <p className={p}>
            ...
            <strong className="text-slate-300">$150/month with a $990 one-off setup</strong>,
          ...
          <ul className={ul}>
            <li>
              ...
              expect around $150/month plus a setup fee from around $990. This handles email
            ...
            <li>
              ...
              $450/month plus setup, where the AI system is paired with a custom website built
